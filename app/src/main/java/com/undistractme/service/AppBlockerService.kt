...
import com.undistractme.MainActivity
...
import com.undistractme.sensor.SensorChallengeManager
...
class AppBlockerService : LifecycleService() {
    ...
    private fun buildNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, Constants.NOTIFICATION_CHANNEL_ID)
            ...
            .setContentText("Watching for distracting apps. Tap to open Un-Distract Me.")
