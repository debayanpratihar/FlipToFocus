 ...
 */
object Constants {
    const val NOTIFICATION_CHANNEL_ID = "fliptofocus_focus_channel"
    ...
    const val ACTION_START = "com.fliptofocus.action.START_BLOCKING"
    const val ACTION_STOP = "com.fliptofocus.action.STOP_BLOCKING"
